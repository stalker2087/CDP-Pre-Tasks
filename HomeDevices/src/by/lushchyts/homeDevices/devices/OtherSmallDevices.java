...
public class OtherSmallDevices extends ElectronicDevice {



    public OtherSmallDevices(String deviceName, int consumingPower) {

        super(deviceName, consumingPower);

    }

    public OtherSmallDevices(String deviceName, int consumingPower, boolean socketStatus, boolean onOff) {
