...
public class SmallKitchenDevices extends ElectronicDevice {


    public SmallKitchenDevices(String deviceName, int consumingPower) {

        super(deviceName, consumingPower);

    }

    public SmallKitchenDevices(String deviceName, int consumingPower, boolean socketStatus, boolean onOff) {
